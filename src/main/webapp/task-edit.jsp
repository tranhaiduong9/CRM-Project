					...
					<li>
						<div class="dropdown">
							<a class="profile-pic dropdown-toggle" data-toggle="dropdown"
								...
								class="hidden-xs">${user.fullName} - ${user.role.name}</b>
							</a>
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a href='<c:url value="/login" />' class="btn-logout">Đăng
										xuất</a></li>
							</ul>
						</div>
					</li>
						...
						<div class="white-box">
							<form action="<c:url value ='/task'/>" method="post"
								...
								<c:forEach var="item" items="${listJobs}">
									<c:if test="${job.id == item.id}">
										<input type="hidden" value="${job.id}" name="idJob">
										<div class="form-group">
											<label class="col-md-12">Tên công việc</label>
											<div class="col-md-12">
												<input type="text" value="${item.name}" name="jobName"
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" readonly value="${item.project.name}"
													class="form-control form-control-line">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" readonly value="${item.user.fullName}"
													class="form-control form-control-line">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" value="${item.startDate}" name="startDate"
													class="form-control form-control-line">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" value="${item.endDate}" name="endDate"
													class="form-control form-control-line">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-12">
												<select class="form-control form-control-line" name=status>
													<c:forEach var="itemstatus" items="${listStatus}">
														<c:if test="${itemstatus.name == item.status}">
															<option value="${itemstatus.id}"
																selected="${itemstatus.name}">
