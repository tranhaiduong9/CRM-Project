                    ...
                    <li>
                        <div class="dropdown">
                            <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                ...
                                <b class="hidden-xs">${user.fullName} - ${user.role.name}</b> 
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href='<c:url value="profile"/>'>Thông tin cá nhân</a></li>
                                <li><a href="#">Thống kê công việc</a></li>
                                <li class="divider"></li>
                                <li><a href='<c:url value="/login"/>' class="btn-logout">Đăng xuất</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <c:if test="${user.role.name == 'ADMIN' || user.role.name == 'LEADER'}">
                    <li>
                        <a href="<c:url value="/users" />" class="waves-effect"><i class="fa fa-user fa-fw"
