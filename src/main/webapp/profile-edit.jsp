						...
						<div class="white-box">
							<form action="<c:url value ='/profile'/>" method="post"
								...
								<c:forEach var="item" items="${listJobs}">
									<c:if test="${idJob == item.id}">
										<input type="hidden" value="${idJob}" name="idJob">
										...
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" readonly value="${item.startDate}"
													class="form-control form-control-line">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-12">
												<input type="text" readonly value="${item.endDate}"
													class="form-control form-control-line">
											</div>
										</div>
										<div class="form-group">
