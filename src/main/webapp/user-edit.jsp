					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="<c:url value ='/user'/>" method="post"
								...
								<input type="hidden" value="${userSelected.id}" name="idUser">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" name="phone" value="${userSelected.phone}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-12">
										<select class="form-control form-control-line" name="role">
											<c:forEach var="item" items="${listRole}">
												<c:if test="${userSelected.role.id != item.id}">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<button type="submit" class="btn btn-success">Sửa
											thành viên</button>
										<a href='<c:url value="/users"/>' class="btn btn-primary">Quay
											lại</a>
									</div>
								</div>
							</form>
