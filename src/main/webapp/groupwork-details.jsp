						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:forEach var="listJobs" items="${listJobs}">
										<c:if
											test="${listJobs.user.id == item.id && listJobs.status == 'Not Started'}">
											<a href="#">
												<div class="mail-contnet">
													<h5>${listJobs.name}</h5>
													<span class="mail-desc"></span> <span class="time">Bắt
														đầu: ${listJobs.startDate}</span> <span class="time">Kết
														thúc: ${listJobs.endDate}</span>
												</div>
											</a>
										</c:if>
									</c:forEach>
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:forEach var="listJobs" items="${listJobs}">
										<c:if
											test="${listJobs.user.id == item.id && listJobs.status == 'In Progress'}">
											<a href="#">
												<div class="mail-contnet">
													<h5>${listJobs.name}</h5>
													<span class="mail-desc"></span> <span class="time">Bắt
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:forEach var="listJobs" items="${listJobs}">
										<c:if
											test="${listJobs.user.id == item.id && listJobs.status == 'Completed'}">
											<a href="#">
												<div class="mail-contnet">
													<h5>${listJobs.name}</h5>
													<span class="mail-desc"></span> <span class="time">Bắt
