						...
						<div class="white-box">
							<form action="<c:url value='task-add'/>" method="post"
								...
								<c:if test="${isSuccess == false}">
									<h4 class="text-danger fs-6">Tạo công việc thất bại, định
										dạng ngày không đúng, vui lòng nhập theo định dạng
										"dd-mm-yyyy"</h4>
								</c:if>
								<c:if test="${isSuccess == true}">
									<h4 class="text-danger fs-6">Tạo công việc thành công</h4>
								</c:if>
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="Tên công việc" name="job-name"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<select class="form-control form-control-line"
											name="user-full-name">
											<c:forEach var="item" items="${listUsersFullName}">
