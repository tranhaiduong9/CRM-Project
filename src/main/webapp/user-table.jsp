					...
					<li>
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a class="btn-thongtin" href="<c:url value="profile"/>">Thông
										tin cá nhân</a></li>
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach var="item" items="${listUsers}" varStatus="count">
											<tr>
												<td>${count.index + 1}</td>
												...
												<td><c:if test="${user.role.name == 'ADMIN'}">
														...
														<a href="#" class="btn btn-sm btn-danger btn-xoa"
															id-user="${item.id}">Xóa</a>
													</c:if> <a href="<c:url value="/user-details?id=${item.id}"/>"
