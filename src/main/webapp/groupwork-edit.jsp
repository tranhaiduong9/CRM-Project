			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="<c:url value ='/groupwork'/>" method="post"
								class="form-horizontal form-material">
								<input type="hidden" value="${project.id}" name="idProject">
								<div class="form-group">
									<label class="col-md-12">Tên dự án</label>
									<div class="col-md-12">
										<input type="text" value="${project.name}" name="projectName"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" value="${project.startDate}"
											name="startDate" class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-12">Ngày kết thúc</label>
									<div class="col-md-12">
										<input type="text" value="${project.endDate}" name="endDate"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
