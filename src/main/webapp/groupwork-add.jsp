						...
						<div class="white-box">
							<form action="<c:url value="groupwork-add"/>" method="post"
								...
								<c:if test="${isSuccess == false}">
									<h4 class="text-danger fs-6">Tạo dự án, định dạng ngày
										không đúng, vui lòng nhập theo định dạng "dd-mm-yyyy"</h4>
								</c:if>
								<c:if test="${isSuccess == true}">
									<h4 class="text-danger fs-6">Tạo dự án thành công</h4>
								</c:if>
								<div class="form-group">
									<label class="col-md-12">Tên dự án</label>
									<div class="col-md-12">
										<input type="text" placeholder="Tên dự án" name="project-name"
